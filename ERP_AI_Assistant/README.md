# 🚀 ERP AI Assistant - Claude API + RAG

## 📋 Opis Projektu

Zaawansowany asystent AI wspierający proces wdrożenia systemu Comarch ERP XL, wykorzystujący **Claude API + RAG** (Retrieval-Augmented Generation):
